...
namespace RootMotion.FinalIK {
	...
	public partial class IKSolverVR: IKSolver {
		...
		private Vector3 GetPelvisOffset() {
			...
			//else
			//{
			//	Vector3 p = spine.pelvis.solverPosition;
			//	p.y = rootBone.solverPosition.y;
			//	rootBone.solverPosition = p;

			//	Vector3 q = rootBone.solverRotation.eulerAngles;
			//	q.y = spine.pelvis.solverRotation.eulerAngles.y;
			//	rootBone.solverRotation.eulerAngles = q;
			//}
